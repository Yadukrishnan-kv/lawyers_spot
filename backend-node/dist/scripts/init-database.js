...
async function main() {
    ...
    try {
        ...
        console.error('Cannot connect with POSTGRES_ADMIN_URL. Set your postgres superuser password, e.g.:');
        console.error('  $env:POSTGRES_ADMIN_URL="postgresql://postgres:YOUR_PASSWORD@localhost:5432/postgres"');
