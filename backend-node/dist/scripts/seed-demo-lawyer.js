...
await pool.query(`INSERT INTO platform_users (id, email, password_hash, name, role, lawyer_id, phone, status)
   ...
   ON CONFLICT (email) DO UPDATE SET
     ...
     status = 'active'`, [DEMO_USER_ID, DEMO_EMAIL, hash, DEMO_NAME, DEMO_LAWYER_ID]);
