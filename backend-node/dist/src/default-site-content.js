...
export const defaultSiteContent = {
    ...
    hero: {
        ...
        subtitle: 'Search verified lawyers, free legal answers, guides & acts — built for scale, SEO & trust.',
    ...
    ipcPage: {
        title: 'IPC Sections',
        subtitle: 'Indian Penal Code — section-wise legal information (legacy code; BNS now applicable for new cases)',
        footerNote: 'Also see <a href="/bns" class="text-royal-600 font-semibold">BNS Sections</a> (Bharatiya Nyaya Sanhita, 2023)',
        metaTitle: 'IPC Sections — Indian Penal Code',
        metaDescription: 'Browse Indian Penal Code (IPC) sections with plain-English explanations. IPC 498A, 420, 302 and more.',
    },
    footer: {
        brandTagline: '',
        sectionTitles: {
    ...
    courtsPage: {
        ...
        metaDescription: 'Advocates practicing in Supreme Court, High Courts, District & Family Courts across India.',
    },
    bnsPage: {
        title: 'BNS Sections',
        subtitle: 'Bharatiya Nyaya Sanhita, 2023 — replaces IPC for new criminal matters',
        footerNote: 'Legacy code: <a href="/ipc" class="text-royal-600 font-semibold">IPC Sections</a>',
        metaTitle: 'BNS Sections — Bharatiya Nyaya Sanhita',
        metaDescription: 'Browse BNS 2023 sections — the new criminal code replacing IPC for offences committed after July 2024.',
    },
};
